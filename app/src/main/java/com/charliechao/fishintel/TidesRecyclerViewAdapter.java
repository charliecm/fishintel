...
import com.charliechao.fishintel.TidesFragment.OnListFragmentInteractionListener;
...
public class TidesRecyclerViewAdapter extends RecyclerView.Adapter<TidesRecyclerViewAdapter.ViewHolder> {
    ...
    public TidesRecyclerViewAdapter(List<DummyItem> items, OnListFragmentInteractionListener listener) {
        mValues = items;
        mListener = listener;
    }
